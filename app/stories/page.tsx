...
import { AlertTriangle, CalendarDays, Eye, Loader2 } from "lucide-react"
  ...
  return (
    <article className="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">{snippet}</p>
        <Link
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-gray-50 py-12 md:py-16 text-center mb-12">
        {/* Added bg-gray-50 and more padding */}
        <div className="container mx-auto px-4">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900">My Stories & Blog</h1>
          <p className="text-lg sm:text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
            Discover insights, ideas, and narratives from me.
          </p>
        </div>
      </header>
      <main className="container mx-auto px-4 pb-12">
        {/* Added pb-12 for more space at bottom */}
        {posts.length === 0 ? (
